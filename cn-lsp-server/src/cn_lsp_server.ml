...
let query_doc _doc _pos =
  failwith "Cn_lsp_server.query_doc"

let query_type _doc _pos =
  failwith "Cn_lsp_server.query_type"
...
let signature_help (_state : State.t) =
  failwith "Cn_lsp_server.signature_help"
